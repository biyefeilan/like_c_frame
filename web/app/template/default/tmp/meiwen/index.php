<?php 
	_C_View::show('header', array(
		'title'			=> '美文赏析 - VIVINICE.COM',
		'keywords'		=> '美文,文章,作文,散文,小说,名家,经典美文',
		'description'	=> '不可错过的美文。',
		'result'		=> array('class'=>'meiwen', 'method'=>'index', 'data'=>null),
	));
?>
<div id="templatemo_content">
	...
	<div id="gallery">
		<ul>
<?php 
	foreach (DB::page(meiwen::TABLE, NULL, array('collect_time'=>'desc'), array('id','title', 'content'), 1, mobt::MAIN_LIST_SIZE, $info) as $article):
?>
			<li>
				<div class="left">
...
<?php endforeach;?>
	...
	<div class="more"><a href="<?php echo Url::mkurl('meiwen', 'mlist', '2');?>">更多》</a></div>
</div>
