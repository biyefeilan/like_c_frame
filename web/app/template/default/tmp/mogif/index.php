<?php 
	_C_View::show('header', array(
		'title'			=> '搞笑图片 - VIVINICE.COM',
		'keywords'		=> '搞笑图片,动态图片,图片下载,搞笑gif',
		'description'	=> '聚集最新最火的搞笑图片，动态gif图片。',
		'result'		=> array('class'=>'mogif', 'method'=>'index', 'data'=>null),
	));
?>
<div id="templatemo_content">
	...
	<div id="gallery">
		<ul>
<?php foreach (DB::page(mogif::TABLE, NULL, array('collect_time'=>'desc'), array('id','title','content'), 1, mogif::MAIN_LIST_SIZE, $info) as $article):?>
			<li>
				<div class="left">
...
<?php endforeach;?>
	...
	<div class="more"><a href="<?php echo Url::mkurl('mogif', 'mlist', '2');?>">更多》</a></div>
</div>
