...
<?php if ( $data !== false):?>
		...
		<div class="content">
			<a href="<?php echo Url::mkurl('mogif', 'download', $data['id']);?>"><img src="<?php echo mogif::loading_src();?>" dat="<?php echo mogif::img_src($data['content']);?>" alt="点击下载-<?php echo $data['title'];?>" /></a>
		</div>
		<div class="guide">
