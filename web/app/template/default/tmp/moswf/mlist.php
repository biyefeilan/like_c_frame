<?php 
	_C_View::show('header', array(
		'title'			=> '搞笑视频列表  - VIVINICE.COM',
		'keywords'		=> '搞笑视频',
		'description'	=> '最新最火的搞笑视频列表。',
		'result'		=> array('class'=>'moswf', 'method'=>'mlist', 'data'=>$page),
	));
?>
<div id="templatemo_content">
	...
	<div id="gallery">
		<ul>
<?php foreach (DB::page(moswf::TABLE, NULL, array('collect_time'=>'desc'), array('id','title','content'), $page, mogif::MAIN_LIST_SIZE, $info) as $article):?>
			<li>
				<div class="left">
...
<?php endforeach;?>
	...
	<div id="pages_list"><?php echo View::pagesList($info, 'moswf', 'mlist');?></div>
</div>
