<?php 
	_C_View::show('header', array(
		'title'			=> '最新电影 - VIVINICE.COM',
		'keywords'		=> '最新电影下载,高清电影,bt下载',
		'description'	=> '最新高清电影bt种子下载。',
		'result'		=> array('class'=>'mobt', 'method'=>'index', 'data'=>null),
	));
?>
<div id="templatemo_content">
	...
	<div id="gallery">
		<ul>
<?php 
	foreach (DB::page(mobt::TABLE, NULL, array('collect_time'=>'desc'), array('id','title', 'content'), 1, mobt::MAIN_LIST_SIZE, $info) as $article):
?>
			<li>
				<div class="left">
					<a href="<?php echo Url::mkurl('mobt', 'show', $article['id']);?>" class="pirobox" title="<?php echo $article['title'];?>" target="_blank"><img src="<?php echo mogif::loading_src();?>" dat="<?php echo mogif::img_src(mobt::img($article['content']), false);?>" daturl="<?php echo mobt::img($article['content']);?>" alt="<?php echo $article['title'];?>" /></a>
				</div>
				<div class="right">
...
<?php endforeach;?>
	...
	<div class="more"><a href="<?php echo Url::mkurl('mobt', 'mlist', '2');?>">更多》</a></div>
</div>
